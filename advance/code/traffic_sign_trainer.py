...
# to start in jupyter:
#   root@user: cd /opt/anaconda3/bin  ./jupyter notebook /root/share/project/udacity/project2_02/CarND-Traffic-Sign-Classifier-Project/Traffic_Sign_Classifier.ipynb
#
...
def run_test():
    ...
    # net  -----------------------------------------------
    logit,features = make_net(input_shape=(height, width, channel), output_shape=(num_class))
